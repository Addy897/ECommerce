...
<div class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    {#if login}
        <div class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
            <section>
                <h3 class="font-bold text-2xl">Welcome to ECommerce</h3>
        ...
        <div class="max-w-lg mx-auto text-center mt-12 mb-6">
            <p class="text-white">Don't have an account? <button href="None" class="font-bold hover:underline" tabindex="-1"  on:click={()=>{login=!login}}>Sign up</button>.</p>
        </div>
    ...
    {:else}
        ...
        <div class="max-w-lg mx-auto text-center mt-12 mb-6">
            <p class="text-white">Already have an account? <button href="None" class="font-bold hover:underline" tabindex="-1"  on:click={()=>{login=!login}}>Sign in</button>.</p>
        </div>
